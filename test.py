...
if __name__ == '__main__':
    ...
    config['EXP']['PRED_FOCAL'] = False # True means using Dust3R to predict focal length during the evaluation
    ...
    try:
        state_dict=torch.load(args.ckpt_path, map_location='cpu', weights_only=False)['state_dict']
    except:
